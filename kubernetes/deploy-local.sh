...
echo "[1/6] Checking Kubernetes connection..."
...
echo "[4/6] Deploying backing services (PostgreSQL, Redis, NATS, MinIO, SonarQube, ZAP)..."
...
echo "[5/6] Waiting for backing services to be ready (this may take 1-2 minutes)..."
...
echo "[6/6] Deploying PSD Cloud microservices..."
